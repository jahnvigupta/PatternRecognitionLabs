...
Original file is located at
    https://colab.research.google.com/drive/1EbgOHdO9szhrRTa3I8yUIpJK_g9LMhgB
"""
...
class3 = pd.read_csv("class3.txt",sep=" ",header=None)
class1 = class1[[0,1]]
class2 = class2[[0,1]]
class3 = class3[[0,1]]
...
for i in range(len(class1_test)):
  prob1 = prob(len(class1_train),mean1,cov1,class1_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  prob2 = prob(len(class2_train),mean2,cov2,class1_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  prob3 = prob(len(class3_train),mean3,cov3,class1_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  if(prob1>prob2 and prob1>prob3):
    corr_pred = corr_pred+1

#Getting correct predictions in class2
for i in range(len(class2_test)):
  prob1 = prob(len(class1_train),mean1,cov1,class2_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  prob2 = prob(len(class2_train),mean2,cov2,class2_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  prob3 = prob(len(class3_train),mean3,cov3,class2_test.iloc[i],len(class1_train)+len(class2_train)+len(class3_train))
  if(prob2>prob1 and prob2>prob3):
    corr_pred = corr_pred+1

#Getting correct predictions in class3
for i in range(len(class3_test)):
  prob1 = prob(len(class1_train),mean1,cov1,class3_test.iloc[i],len(class3_train)+len(class2_train)+len(class3_train))
  prob2 = prob(len(class2_train),mean2,cov2,class3_test.iloc[i],len(class3_train)+len(class2_train)+len(class3_train))
  prob3 = prob(len(class3_train),mean3,cov3,class3_test.iloc[i],len(class3_train)+len(class2_train)+len(class3_train))
  if(prob3>prob2 and prob3>prob1):
    corr_pred = corr_pred+1

#Printing accuracy
print("Accuracy is : ",corr_pred/(len(class1_test)+len(class2_test)+len(class3_test)))